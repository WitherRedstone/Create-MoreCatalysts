 ...
 * 铁砧工艺鼓风机加工类型基类
 */
public abstract class AnvilcraftFanCommonType implements FanProcessingType {

    private final AnvilcraftFanRecipeType.RecipeTypeEntry recipeType;

    /**
     * 构造函数：绑定特定的鼓风机配方类型
     * @param recipeType 鼓风机配方类型入口
     */
    protected AnvilcraftFanCommonType(AnvilcraftFanRecipeType.RecipeTypeEntry recipeType) {
