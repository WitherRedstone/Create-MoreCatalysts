 ...
 * 批量腐化配方生成器
 */
public class CorruptedRecipeGen extends AnvilcraftFanRecipeGen{

    {
        // 任何生肉 → 腐肉
        convert(() -> Ingredient.of(ModItemTags.FOODS_RAW_MEAT),
                new ICondition[]{
    ...
    public CorruptedRecipeGen(PackOutput output) {
