 ...
 * 批量苔化配方生成器
 */
public class MossifyRecipeGen extends FanRecipeGen<FanRecipe> {
     ...
     */
    public MossifyRecipeGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
