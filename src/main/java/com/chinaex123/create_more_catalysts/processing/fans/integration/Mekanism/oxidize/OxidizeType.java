...
public final class OxidizeType extends MekanismFanCommonType {
    ...
    private static final List<OxidizeType.PotionEffectEntry> POTION_EFFECTS = new ArrayList<>();
                ...
                try {
                    ...
                    if (effectLoc != null) {
                        BuiltInRegistries.MOB_EFFECT.getHolder(effectLoc).ifPresent(eff ->
                                POTION_EFFECTS.add(new OxidizeType.PotionEffectEntry(eff, duration, amplifier)));
                    }
                } catch (NumberFormatException e) {
    ...
    protected void affectLivingEntity(LivingEntity living, Level level) {
        ...
        // 为配置的实体施加状态效果
        for (OxidizeType.PotionEffectEntry entry : POTION_EFFECTS) {
