...
public class EtchRecipeGen extends MekanismFanRecipeGen<FanRecipe> {

    {
        ...
        // 石头 → 沙砾
        convert(() -> Ingredient.of(Tags.Items.STONES), () -> Items.GRAVEL, 1.0f, new ModLoadedCondition("mekanism"));
    }
    ...
    public EtchRecipeGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
