...
public final class ResonanceType extends FanCommonType {
        ...
        for (String heal : heals) {
            ...
            if (parts.length == 2) {
                ...
                try {
                    ...
                    CreateMoreCatalysts.LOGGER.warn("Invalid heal amount in resonance config: {}", heal);
                }
            }
        }
    }
    ...
    public boolean isValidAt(Level level, BlockPos pos) {
        ...
        return isValidBlockCatalyst(level, pos, ModBlockTags.FAN_CATALYSTS_RESONANCE);
    }
