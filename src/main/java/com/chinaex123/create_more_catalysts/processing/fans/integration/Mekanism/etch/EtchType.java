...
public final class EtchType extends MekanismFanCommonType {
        ...
        for (String heal : heals) {
            ...
            if (parts.length == 2) {
                ...
                try {
                    ...
                    CreateMoreCatalysts.LOGGER.warn("Invalid heal amount in etch config: {}", heal);
                }
            }
        }
    }
    ...
    protected void affectLivingEntity(LivingEntity living, Level level) {
        ...
        living.addEffect(new MobEffectInstance(MobEffects.POISON, 20 * 10, 3));
        living.addEffect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 20 * 10, 2));
        living.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 20 * 10, 1));
