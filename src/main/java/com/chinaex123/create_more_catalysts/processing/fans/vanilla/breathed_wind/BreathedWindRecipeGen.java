 ...
 * 批量吐息配方生成器
 */
public class BreathedWindRecipeGen extends FanRecipeGen {

    {
        // 甜浆果 → 紫颂果
        convert(() -> Ingredient.of(Items.SWEET_BERRIES), () -> Items.CHORUS_FRUIT);
        // 皮革 → 幻翼膜
        convert(() -> Ingredient.of(Tags.Items.LEATHER), () -> Items.PHANTOM_MEMBRANE);
     ...
     */
    public BreathedWindRecipeGen(PackOutput output) {
