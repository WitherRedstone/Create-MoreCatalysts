...
public abstract class ImmersiveEngineeringFanCommonType implements FanProcessingType {
    ...
    private final ImmersiveEngineeringFanRecipeType.RecipeTypeEntry recipeType;

    /**
     * 构造函数：绑定特定的鼓风机配方类型
     * @param recipeType 鼓风机配方类型入口
     */
    protected ImmersiveEngineeringFanCommonType(ImmersiveEngineeringFanRecipeType.RecipeTypeEntry recipeType) {
