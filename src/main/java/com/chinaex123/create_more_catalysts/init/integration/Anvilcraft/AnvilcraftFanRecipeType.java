 ...
 * 鼓风机配方类型注册器
 */
public final class AnvilcraftFanRecipeType {
    ...
    // =============================== 模组联动内容 ===============================
    public static RecipeTypeEntry CORRUPTED; // 鼓风机 - 批量腐化
    ...
    static {
        // 鼓风机 - 批量腐化
        CORRUPTED = registerStandard("corrupted", params -> new FanRecipe(CORRUPTED, params));


    }

    private AnvilcraftFanRecipeType() {}
