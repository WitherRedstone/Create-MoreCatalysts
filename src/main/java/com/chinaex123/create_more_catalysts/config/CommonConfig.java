...
public class CommonConfig {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> WITHERING_POTION_EFFECTS; // 批量凋零状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SNOW_FLOW_POTION_EFFECTS; // 批量雪流状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> PURIFYING_POTION_EFFECTS; // 批量净化状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SCULKING_POTION_EFFECTS; // 批量幽匿状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> RESONANCE_POTION_EFFECTS; // 批量共振状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SAND_BLOW_POTION_EFFECTS; // 批量扬砂状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> BREATHED_WIND_POTION_EFFECTS; // 批量吐息状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> EXPLODING_POTION_EFFECTS; // 批量爆炸状态效果列表

    public static final ModConfigSpec.BooleanValue ENABLE_TIDAL_FAN; // 批量海潮
    public static final ModConfigSpec.ConfigValue<List<? extends String>> TIDAL_ENTITY_TRANSFORMS; // 批量海潮实体转换列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> TIDAL_HEAL_ENTITIES; // 批量海潮治疗实体列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> TIDAL_POTION_EFFECTS; // 批量海潮状态效果列表

    public static final ModConfigSpec.BooleanValue ENABLE_TEAR_FAN; // 批量催泪
    public static final ModConfigSpec.ConfigValue<List<? extends String>> TEAR_ENTITY_TRANSFORMS; // 批量催泪实体转换列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> TEAR_HEAL_ENTITIES; // 批量催泪治疗实体列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> TEAR_POTION_EFFECTS; // 批量催泪状态效果列表

    public static final ModConfigSpec.BooleanValue ENABLE_MOSSIFY_FAN; // 批量苔化
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MOSSIFY_ENTITY_TRANSFORMS; // 批量苔化实体转换列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MOSSIFY_HEAL_ENTITIES; // 批量苔化治疗实体列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MOSSIFY_POTION_EFFECTS; // 批量苔化状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> HONEY_COATING_POTION_EFFECTS; // 批量裹蜜状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CHOCOLATE_COATING_POTION_EFFECTS; // 批量凝巧状态效果列表


    // =============================== 模组联动内容 ===============================
    public static final ModConfigSpec.BooleanValue ENABLE_SALOUT_FAN; // 批量盐析
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SALOUT_ENTITY_TRANSFORMS; // 批量盐析实体转换列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SALOUT_HEAL_ENTITIES; // 批量盐析治疗实体列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SALOUT_POTION_EFFECTS; // 批量盐析状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> ETCH_POTION_EFFECTS; // 批量蚀刻状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> SULFON_POTION_EFFECTS; // 批量磺化状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> DEHYD_POTION_EFFECTS; // 批量脱水状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> OXIDIZE_POTION_EFFECTS; // 批量氧化状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> REDUCE_POTION_EFFECTS; // 批量还原状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> FERMENT_POTION_EFFECTS; // 批量发酵状态效果列表
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> PRESERVATION_POTION_EFFECTS; // 批量防腐状态效果列表

    public static final ModConfigSpec.BooleanValue ENABLE_CORRUPTED_FAN; // 批量腐化
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CORRUPTED_ENTITY_TRANSFORMS; // 批量腐化实体转换列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CORRUPTED_HEAL_ENTITIES; // 批量腐化治疗实体列表
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CORRUPTED_POTION_EFFECTS; // 批量腐化状态效果列表
    ...
    static {
        ...
        WITHERING_ENTITY_TRANSFORMS = builder
                ...
                .defineList("witheringEntityTransforms",
                        List.of(
                                "minecraft:skeleton->minecraft:wither_skeleton",  // 骷髅->凋零骷髅
                                ""
                        ),
