 ...
 * 通用机械鼓风机配方生成器基类
 */
public abstract class MekanismFanRecipeGen<R extends StandardProcessingRecipe<?>> extends StandardProcessingRecipeGen<R> {

    protected MekanismFanRecipeGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
